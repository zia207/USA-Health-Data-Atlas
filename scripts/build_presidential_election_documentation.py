#!/usr/bin/env python3
"""Build presidential_election_documentation.html from US_County_Presidential_Election_Data.md."""
...
MD_FILE = ROOT / "data" / "presidential_election_data" / "US_County_Presidential_Election_Data.md"
OUT = ROOT / "presidential_election_documentation.html"

MEDSL_URL = "https://electionlab.mit.edu/"
TONMCG_URL = "https://github.com/tonmcg/US_County_Level_Election_Results_08-24"
...
<title>Presidential Election Data Documentation · USA-Health Data Atlas</title>
<style>
:root {{
...
<body>
    ...
    <div class="banner-inner">
      <div class="banner-top">
        <div class="banner-copy">
          <div class="eyebrow">USA-Health Data Atlas · MEDSL / tonmcg</div>
          <h1 class="page-title">Presidential Election <span>Documentation</span></h1>
          <p class="sub">
            Dataset documentation for county-level U.S. presidential election returns,
            2004–2024 — vote counts, percentages, and Democratic margin.
          </p>
        </div>
        <div class="banner-aside">
          ...
          <nav class="explorer-nav" aria-label="Atlas navigation">
            ...
            <a class="active" href="presidential_election_documentation.html" aria-current="page">Documentation</a>
          </nav>
        </div>
      </div>
    </div>
  ...
  <div class="layout">
    <aside class="toc" aria-label="Table of contents">
      ...
      <div class="actions">
        <a class="btn" href="usa_presidential_election_data.html">Open Election Explorer</a>
        <a class="btn ghost" href="{medsl_url}" target="_blank" rel="noopener">MIT Election Lab</a>
        <a class="btn ghost" href="{tonmcg_url}" target="_blank" rel="noopener">tonmcg 2024 feed</a>
      </div>
    </aside>
    <main class="content">
      <article class="doc-section" id="presidential-election">{body}</article>
    </main>
  </div>

  <footer class="footer">
  Generated from <code>data/presidential_election_data/US_County_Presidential_Election_Data.md</code>.
  County returns from MEDSL (2004–2020) and tonmcg (2024).
  </footer>
</body>
</html>
"""
